...
//    navbarFixed();
    ...
    function l_product_slider_kit() {
        if ($('.l_product_slider_kit').length) {
            $('.l_product_slider_kit').owlCarousel({
                loop: true,
                margin: 20,
                items: 2,
                nav: true,
                ...
                smartSpeed: 1500,
                dots: false,
                navContainerClass: 'l_product_slider_kit',
                navText: ['<i class="arrow_carrot-left" aria-hidden="true"></i>', '<i class="arrow_carrot-right" aria-hidden="true"></i>'],
                responsiveClass: true,
                responsive: {
                    0: {
